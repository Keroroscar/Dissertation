...
*2.1 fdi invested*
local xx2  " lso2 gov_b  secgrp_b pgrp_b wage_b laborinsec_b  delivery  density_b laborval i.year"
...
*3.1 fdi
local xx3  " lfdi_a gov_a  pgrp_a secgrp_a  wage_a laborinsec_a delivery  density_a laborval  i.year"
local gmm3 " lso2    lfdi_a gov_a   secgrp_a    laborinsec_a  density_a   laborval"
local iv3  "                        delivery       pgrp_a   lwage_a           i.year"
xtabond2 lso2  `xx3', gmm(`gmm3') iv(`iv3') twostep robust
est store panel3a
...
local xx3  " lfdi_a gov_a  pgrp_a secgrp_a  wage_a laborinsec_a delivery  density_a laborval  i.year"
local gmm3 " lso2    lfdi_a gov_a    pgrp_a   lwage_a  secgrp_a    laborinsec_a        "
local iv3  "                      delivery           density_a   laborval              i.year"
xtabond2 lso2  `xx3', gmm(`gmm3') iv(`iv3') twostep robust
est store panel3a
outreg2 panel3a using data3,excel replace ctitle ("SYS-GMM3.1") e(ar1 ar1p ar2 ar2p sargan sarganp hansen hansenp N)  noobs bdec(3) sdec(3) drop(i.year)
...
local xx3  " lHMT_a gov_a  pgrp_a secgrp_a  wage_a laborinsec_a delivery  density_a laborval  i.year"
local gmm3 " lso2    lHMT_a gov_a    pgrp_a   lwage_a  secgrp_a    laborinsec_a        "
local iv3  "                      delivery           density_a   laborval              i.year"
xtabond2 lso2  `xx3', gmm(`gmm3') iv(`iv3') twostep robust
est store panel3a
outreg2 panel3a using data3,excel replace ctitle ("SYS-GMM3.1") e(ar1 ar1p ar2 ar2p sargan sarganp hansen hansenp N)  noobs bdec(3) sdec(3) drop(i.year)
...
*3.3
local xx3  " ldomestic_a gov_a ) pgrp_a secgrp_a  lwage_a laborinsec_a  delivery  density_a laborval i.year"

...
local gmm3 " L.lso2    L(0/1).(lfdi_a gov_a)   secgrp_a    pgrp_a laborinsec_a  "
local iv3  " L2.so2                       delivery         wage_a  density_a   laborval         i.year"
...
local gmm3 " L.lso2    L(0/1).(lHMT_a gov_a )   secgrp_a    pgrp_a laborinsec_a  "
local iv3  " L2.lso2                 delivery         wage_a  density_a    laborval       i.year"
xtabond2 lso2 L.lso2 L2.lso2 `xx3', gmm(`gmm3') iv(`iv3') twostep robust
est store panel3a
...
local gmm3 " L.lso2    L(0/1).(ldomestic_a gov_a )   secgrp_a    pgrp_a laborinsec_a  "
local iv3  " L2.lso2                 delivery         wage_a  density_a    laborval       i.year"
xtabond2 lso2 L.lso2 L2.lso2 `xx3', gmm(`gmm3') iv(`iv3') twostep robust
est store panel3a
...
*3.4
local xx3  " L(0/1).(rfdi_a gov_a ) pgrp_a secgrp_a  wage_a laborinsec_a  delivery  density_a laborval  i.year"
local gmm3 " L.lso2    L(0/1).(rfdi_a gov_a )   secgrp_a    pgrp_a laborinsec_a  "
local iv3  " L2.lso2                 delivery         wage_a  density_a     laborval       i.year"
xtabond2 lso2 L.lso2 L2.lso2 `xx3', gmm(`gmm3') iv(`iv3') twostep robust
est store panel3a
outreg2 panel3a using data3,excel append ctitle ("SYS-GMM3.1") e(ar1 ar1p ar2 ar2p sargan sarganp hansen hansenp N)  noobs bdec(3) sdec(3) drop(i.year)

*4.1 fdi
local xx4  " L(0/1).(fdi_b gov_b ) pgrp_b secgrp_b  wage_b laborinsec_b  delivery  density_b laborval  i.year"
local gmm4 " L.lso2    L(0/1).(fdi_b gov_b)   secgrp_b    pgrp_b laborinsec_b  "
local iv4  " L2.lso2                       delivery         wage_a  density_b   laborval         i.year"
xtabond2 lso2 L.lso2 L2.lso2 `xx4', gmm(`gmm4') iv(`iv4') twostep robust
est store panel4b
outreg2 panel4b using data3,excel replace ctitle ("SYS-GMM4.1") e(ar1 ar1p ar2 ar2p sargan sarganp hansen hansenp N)  noobs bdec(3) sdec(3) drop(i.year)

*4.2
local xx4  " L(0/1).(HMT_b gov_b ) pgrp_b secgrp_b  wage_b laborinsec_b  delivery  density_b laborval i.year"
...
*4.3
local xx4  " L(0/1).(domestic_b gov_b ) pgrp_b secgrp_b  wage_b laborinsec_b  delivery  density_b laborval i.year"
...
*4.4
local xx4  " L(0/1).(rfdi_b gov_b ) pgrp_b secgrp_b  wage_b laborinsec_b  delivery  density_b laborval i.year"
...
*5.1
local xx5  " L(0/1).(fdi_a lso2 ) pgrp_a secgrp_a  wage_a laborinsec_a  delivery  density_a laborval i.year"
local gmm5 " L.gov_a    L(0/1).(fdi_a lso2)   secgrp_a    pgrp_a laborinsec_a  "
local iv5  "                       delivery         wage_a  density_a   laborval         i.year"
...
*5.2
local xx5  " L(0/1).(HMT_a lso2) pgrp_a secgrp_a  wage_a laborinsec_a  delivery  density_a laborval i.year"
local gmm5 " L.gov_a   L(0/1).(HMT_a lso2)   secgrp_a  density_a laborinsec_a  "
local iv5  "                    delivery         wage_a    laborval    pgrp_a       i.year"
xtabond2 gov_a L.gov_a  `xx5', gmm(`gmm5') iv(`iv5') twostep robust
est store panel5a
outreg2 panel5a using data9,word replace ctitle ("SYS-GMM5.1") e(ar1 ar1p ar2 ar2p sargan sarganp hansen hansenp N)  noobs bdec(3) sdec(3) drop(i.year)

*5.3
local xx5  " L(0/1).(domestic_a lso2) pgrp_a secgrp_a  wage_a laborinsec_a  delivery  density_a laborval i.year"
...
*5.4
local xx5  " L(0/1).(rfdi_a lso2) pgrp_a secgrp_a  wage_a laborinsec_a  delivery  density_a laborval i.year"
...
*6.1 fdi
local xx6  " L(0/1).(fdi_b lso2 ) pgrp_b secgrp_b  wage_b laborinsec_b  delivery  density_b laborval i.year"
local gmm6 " L.lso2    L(0/1).(fdi_b lso2)   secgrp_b    pgrp_b laborinsec_b  "
local iv6  "                       delivery         wage_a  density_b  laborval         i.year"
...
*6.2
local xx6  " L(0/1).(HMT_b lso2 ) pgrp_b secgrp_b  wage_b laborinsec_b  delivery  density_b laborval i.year"
...
*6.3
local xx6  " L(0/1).(domestic_b lso2 ) pgrp_b secgrp_b  wage_b laborinsec_b  delivery  density_b laborval i.year"
local gmm6 " L.lso2    L(0/1).(domestic_b lso2)   secgrp_b   laborinsec_b  "
local iv6  "                       delivery        pgrp_b   wage_a  density_b   laborval         i.year"
xtabond2 gov_b L.gov_b `xx6', gmm(`gmm6') iv(`iv6') twostep robust
est store panel6c
...
*6.4
local xx6  " L(0/1).(rfdi_b lso2 ) pgrp_b secgrp_b  wage_b laborinsec_b  delivery  density_b laborval  i.year"

...
xtreg lso2_b L.lso2_b ldomestic_b lHMT_b lland_b lfdi_b lgov_b lfine `xx', fe 
...
xtreg lso2_c L.lso2_c ldomestic_c lHMT_c lfdi_c lgov_c lfine `xx', re cluster (id)
...
xtreg lso2_b L.lso2_b ldomestic_b  lgov_b lfine `xx',fe cluster(id)
outreg2 using data11,excel append ctitle ("domestic ") drop(year1-year8) e( N) 
 
 
local xx " llaborinsec_b  lpopu_b lsecgrp_b lland_b ldelivery_b lwage_b  year1-year8"
xtreg lso2_b L.lso2_b lHMT_b lgov_b lfine `xx', fe cluster(id)
...
xtreg lso2_b L.lso2_b lfdi_b  lgov_b lfine `xx', fe cluster(id)
...
xtreg lso2_c L.lso2_c ldomestic_c lland_c lgov_c lfine `xx' ,re cluster(id)
...
xtreg lso2_c L.lso2_c lHMT_c lland_c lgov_c lfine `xx', re cluster(id) 
...
xtreg lso2_c L.lso2_c lfdi_c lland_c lgov_c lfine lpopu_c `xx',re cluster(id)
outreg2 using data11,excel append ctitle ("fdi_b ") drop(year1-year8) e( N)
